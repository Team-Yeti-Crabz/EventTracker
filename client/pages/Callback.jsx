...
export default function Callback() {
  ...
  //   //& Back end call to /api/authentication/callback
  //   try {
  ...
  //      //-------
  //     console.log('NITESH TEST STARTS HERE i pray');

  //     //& Back end call to /api/authentication/email
      
  //     const response2 = await fetch('api/authentication/email', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'Application/JSON',
  //       },
  ...
  //     });
  //     const checkUser = await response2.json();
